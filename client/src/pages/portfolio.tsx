        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="text-center">
            <ScrollAnimations>
              ...
              >
                Create stunning portfolios with integrated resume showcase and
                project highlights
              </p>
              <Button
                size="lg"
          ...
          <ScrollAnimations>
            <div className="text-center mb-16">
              <h2
                ...
                data-testid="heading-featured-portfolios"
              >
                Featured Portfolios
              </h2>
              <p
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16" data-testid="empty-portfolios">
              ...
              <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                Be the first to create a stunning portfolio and showcase your
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p
                              ...
                              data-testid={`portfolio-title-${portfolio.id}`}
                            >
                              {portfolio.title}
                            </p>
                            <div className="flex items-center space-x-2 mt-1">
                              {portfolio.email && (
                                <Mail
                                  className="h-4 w-4"
                                  data-testid={`portfolio-email-icon-${portfolio.id}`}
                                />
                              )}
                              {portfolio.linkedin && (
                                <Linkedin
                                  className="h-4 w-4"
                                  data-testid={`portfolio-linkedin-icon-${portfolio.id}`}
                                />
                              )}
                              {portfolio.github && (
                                <Github
                                  className="h-4 w-4"
                                  data-testid={`portfolio-github-icon-${portfolio.id}`}
                                />
                              )}
                            </div>
                          </div>
                      ...
                      <div className="p-6">
                        <div className="mb-4">
                          <p
                            ...
                            data-testid={`portfolio-bio-${portfolio.id}`}
                          >
                            {portfolio.bio}
                          </p>
                        </div>
                              ...
                              {portfolio.skills
                                ...
                                .map((skill, skillIndex) => (
                                  <Badge
                                    ...
                                    variant="secondary"
                                    className="text-xs"
                                    data-testid={`portfolio-skill-${portfolio.id}-${skillIndex}`}
                                  >
                                    {skill}
                                  </Badge>
                                ))}
                                ...
                                {portfolio.projects
                                  ...
                                  .map((project, projectIndex) => (
                                    <div
                                      ...
                                      data-testid={`portfolio-project-${portfolio.id}-${projectIndex}`}
                                    >
                                      <div>
                          ...
                          <div className="mb-6">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                data-testid={`button-download-resume-${portfolio.id}`}
                              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <ScrollAnimations key={index}>
                <Card
                  className="text-center fade-in-up card-hover"
                  style={{ "--stagger": index + 1 } as any}
